...
# 从项目根目录
cd .
go build -o main/fetch_server.exe ./main/fetch_server.go  # Windows
go build -o main/fetch_server ./main/fetch_server.go      # Linux/Mac
```
...
ExecStart=/path/to/main/fetch_server
Restart=always
